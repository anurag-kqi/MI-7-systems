...
int sockfd, newsockfd, portno,writefd;
                ...
                switch (ch) {
                    case 1:
                      ...
                      read(newsockfd, &stud, sizeof(struct student_disk));
			                ...
			                insert_stud(stud);
									    write_stud(stud);
									    num_records++;
											write(newsockfd, &num_records, sizeof(num_records));
										//}
					          //read_stud();	    }
                      printf("\n_______________________________________________________________________________\n");
				              printf("\t\tSTUDENT DATAFILE\n\n");
                   ...
                   case 2:
                       ...
                       printf("\n\tINDEX : %d\n\tID : %d\n\tNAME : %s\n\tDEPARTMMENT : %s\n\tCONTACT %d", teach.index, teach.id, teach.name, teach.department, stud.contact);
									     ...
									     write_teach(teach);
									     num_record++;
											 write(newsockfd, &num_record, sizeof(num_record));
