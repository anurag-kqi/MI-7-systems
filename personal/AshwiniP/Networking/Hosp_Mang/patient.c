...
void read_pat();
void write_pat(struct patient_disk stud);
void delete_pat_file(struct patient_disk patData);
void update_pat_file(struct patient_disk patData);
void insert_pat(struct patient_disk readpat);
void display_pat(int sockfd);
void search_pat(int id, int newsockfd);
void update_pat(struct patient_disk upsd);
