...
extern void write_society_D(struct society socty);
                 ...
                 scanf("%d", &ch);
                  ...
                  switch(ch)
                  {
                      case 1: //fptr = (fopen("society_D.txt","a+"));
                              printf("\n\n\tEnter owner_name : ");
                              scanf("\t %[^\n]%*c", socty.soc.owner_name);
                              printf("\n\tEnter flat_num : ");
                              scanf("\t %d", &socty.soc.flat_num);
                              printf("\n\tEnter owner_contact : ");
                              scanf("\t %d", &socty.soc.owner_contact);
                              //insert_society_D(owner_name, flat_num, owner_contact);
                              write_society_D(socty);
				                      read_society_D();
        	                    break;
