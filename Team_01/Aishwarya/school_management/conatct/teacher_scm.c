...
void write_teacher();
extern void insert_teacher(int id, char name[], char department[], char contact[]);
...
void read_teacher()
{
    ...
    while (( fscanf(fptr, "%d %[^\n]%*c %[^\n]%*c %s", &id, name, department, contact)) != EOF) {
...
void insert_teacher(int id, char name[], char department[], char contact[])
{
...
void update_teacher(int id)
{
    ...
    if (ptr == NULL) {
		...
		int id;
    		char name[30], department[30], contact[10];
