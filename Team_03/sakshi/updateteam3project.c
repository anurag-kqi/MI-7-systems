...
{	char x;
	...
	s = "sr.no";
	char *BI = (char*)malloc(sizeof(char));
	BI = "Business ID";
	char *BN = (char*)malloc(sizeof(char));
	BN = "Business Name";
	char *BO = (char*)malloc(sizeof(char));
	BO = "Business Owner";
	char *BT = (char*)malloc(sizeof(char));
	BT = "Business Type";
	char *CO = (char*)malloc(sizeof(char));
	CO = "Contact no.";
	char *CA = (char*)malloc(sizeof(char));
	CA = "Contact Address";
	char *CE = (char*)malloc(sizeof(char));
	CE = "Email";
	int OID;
	char bName[15];
	char oName[16];
	...
	scanf("%d",&n);
	struct Node_at *key= (struct Node_at*)malloc(sizeof(struct Node_at));
